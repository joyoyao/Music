 ...
 * playlists, recent, artists, albums, songs, and genre {@link android.support.v4.app.Fragment} s for
 * phones.
 *
...
public class MusicBrowserPhoneFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        // Initialze the TPI
        final PagerSlidingTabStrip pageIndicator = (PagerSlidingTabStrip) rootView
    ...
    private AlbumFragment getAlbumFragment() {
        return (AlbumFragment) mPagerAdapter.getFragment(2);
    }
    ...
    private SongFragment getSongFragment() {
        return (SongFragment) mPagerAdapter.getFragment(3);
    }
