...
public class SearchActivity extends ActionBarActivity implements LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(PreferenceUtils.getInstance(this).getDefaultThemeColor(this)));
        mResources.transWindows(this, PreferenceUtils.getInstance(this).getDefaultThemeColor(this));
        // Fade it in
...
//        background.setBackgroundDrawable(getResources().getDrawable(R.drawable.pager_background));
        ...
        Log.i("way", "mFilterString = " + mFilterString);
