...
public class ArtistAdapter extends ArrayAdapter<Artist> {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        MusicHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mActivity).inflate(mLayoutId, parent, false);
        ...
        holder.mLineTwo.get().setText(dataHolder.mLineTwo + "   " + dataHolder.mLineThree);
    ...
    public void buildCache() {
        ...
        for (int i = 0; i < getCount(); i++) {
            ...
            mData[i].mLineTwo = MusicUtils.makeLabel(mActivity,
                    R.plurals.Nalbums, artist.mAlbumNumber);
            // Number of songs (line three)
            mData[i].mLineThree = MusicUtils.makeLabel(mActivity,
     ...
     * list.
     *
     * @param artist   The {@link android.widget.ImageView} holding the aritst image
    ...
    private void playArtist(final ImageView artist, final int position) {
        artist.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                final long[] list = MusicUtils.getSongListForArtist(mActivity, id);
                MusicUtils.playAll(mActivity, list, 0, false);
            }
        });
    }
