...
public abstract class BasePlaylistDialog extends DialogFragment {
    ...
    /**
     * Simple {@link android.text.TextWatcher}
     */
    ...
    /**
     * Called when the save button of our {@link android.app.AlertDialog} is pressed
     */
    public abstract void onSaveClick();

    /**
     * Called in our {@link android.text.TextWatcher} during a text change
     */
