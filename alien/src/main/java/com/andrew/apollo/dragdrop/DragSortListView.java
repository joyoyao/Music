...
public class DragSortListView extends ListView {
    ...
    /**
     * As opposed to {@link android.widget.ListView#getAdapter()}, which returns a heavily
     ...
     *                 {@link android.widget.ListView#getChildAt()}).
     ...
     * {@link #startDrag(int, android.view.View, int, int, int)} after obtaining the floating
     ...
     * {@link android.widget.BaseAdapter#notifyDataSetChanged()} or something like it. When an
     ...
     * {@link com.andrew.apollo.dragdrop.DragSortListView.DragScrollProfile}.
     *
     * @param ssp
     */
    ...
    public interface FloatViewManager {
         ...
         * {@link android.view.ViewGroup.LayoutParams} on this View; otherwise it will set
         ...
         *                 {@link android.widget.ListView#getChildAt(int)}, you will need to add
         *                 {@link android.widget.ListView#getHeaderViewsCount()} to the index).
         ...
         *                  {@link com.andrew.apollo.dragdrop.DragSortListView#startDrag}.
     ...
     * call {@link android.widget.BaseAdapter#notifyDataSetChanged()} or something like it in
     * your implementation.
     *
     * @author heycosmo
     */
    ...
    /**
     * Make sure to call {@link android.widget.BaseAdapter#notifyDataSetChanged()} or something
     ...
     * and time. Use
     * {@link com.andrew.apollo.dragdrop.DragSortListView#setDragScrollProfile(com.andrew.apollo.dragdrop.DragSortListView.DragScrollProfile)} to set
     * custom profile.
     *
     * @author heycosmo
     */
