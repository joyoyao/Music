...
public final class MusicUtils {
     ...
     * @param callback The {@link android.content.ServiceConnection} to use
     * @return The new instance of {@link com.andrew.apollo.utils.MusicUtils.ServiceToken}
     */
    ...
    /**
     * @param token The {@link com.andrew.apollo.utils.MusicUtils.ServiceToken} to unbind from
     */
    ...
    /**
     * @param cursor The {@link android.database.Cursor} used to perform our query.
     ...
     */
    public static final long[] getSongListForArtist(final Context context,
                                                    final long id) {
     ...
     */
    public static final long[] getSongListForAlbum(final Context context,
                                                   final long id) {
        final String[] projection = new String[]{BaseColumns._ID};
     ...
     */
    public static final long[] getSongListForGenre(final Context context,
                                                   final long id) {
        final String[] projection = new String[]{BaseColumns._ID};
     ...
     */
    public static void playAll(final Context context, final long[] list,
     ...
     */
    public static final long getIdForPlaylist(final Context context,
                                              final String name) {
        Cursor cursor = context.getContentResolver().query(
     ...
     */
    public static final long getIdForArtist(final Context context,
                                            final String name) {
        Cursor cursor = context.getContentResolver().query(
     ...
     */
    public static final long getIdForAlbum(final Context context,
    ...
    /*  */
    public static void makeInsertItems(final long[] ids, final int offset,
     ...
     */
    public static final long createPlaylist(final Context context,
                                            final String name) {
        if (name != null && name.length() > 0) {
            ...
            if (cursor.getCount() <= 0) {
                ...
                final Uri uri = resolver
                        .insert(Playlists.EXTERNAL_CONTENT_URI,
                                values);
    ...
    public static void clearPlaylist(final Context context, final int playlistId) {
        final Uri uri = Playlists.Members.getContentUri(
                "external", playlistId);
     ...
     */
    public static final String getSongCountForAlbum(final Context context,
                                                    final long id) {
        if (id == -1) {
            return null;
        }
    ...
    /**
     * @param context    The {@link android.content.Context} to sue
     * @param playlistId The playlist Id
     * @return The track list for a playlist
     */
    public static final long[] getSongListForPlaylist(final Context context,
                                                      final long playlistId) {
    ...
    /**
     * @param cursor The {@link android.database.Cursor} used to gather the list in our favorites
     *               database
     ...
     * @param subMenu       The {@link android.view.SubMenu} to add to.
     * @param showFavorites True if we should show the option to add to the Favorites
     *                      cache.
     */
    ...
    public static String getLrcPath(String path, ContentResolver resolver) {
        String lrcPath = null;
        Cursor cursor = null;
        String LRC_EXTENSION = ".lrc";

        String[] LYRIC_PREJECTION = {MediaStore.Audio.Media.DATA};
        try {
            Uri uri = Uri.parse(path);
            cursor = resolver.query(uri, LYRIC_PREJECTION, null, null, null);
            if (cursor != null && cursor.moveToFirst()) {
                lrcPath = cursor.getString(0);
                int ind = lrcPath.lastIndexOf('.');
                lrcPath = lrcPath.substring(0, ind) + LRC_EXTENSION;
                File file = new File(lrcPath);
                if (!file.exists()) {
                    int isd = lrcPath.lastIndexOf('/');
                    String tractName = lrcPath.substring(isd + 1, ind);
                    return StringConstant.CURRENT_PATH.getAbsolutePath()
                            + File.separator + StringConstant.LRC_DIRECTORY
                            + File.separator + tractName
            ...
            Log.e("liweiping", "GET LRC PATH ERROR:" + e.getMessage());
        } finally {
            if (cursor != null) {
                try {
                    cursor.close();
                } catch (Exception e) {
                    Log.e("liweiping", "GET LRC PATH CLOSE ERROR:" + e.getMessage());
                }
            }
        }
        return lrcPath;
    ...
    public static final class ServiceBinder implements ServiceConnection {
         ...
         *
         * @param context The {@link android.content.ServiceConnection} to use
         */
    ...
    public static final class ServiceToken {
         ...
         *
         * @param context The {@link android.content.ContextWrapper} to use
         */
