...
public final class ApolloUtils {
    ...
    /**
     * Creates a new instance of the {@link com.andrew.apollo.cache.ImageCache} and {@link com.andrew.apollo.cache.ImageFetcher}
     *
     * @param activity The {@link android.app.Activity} to use.
     * @return A new {@link com.andrew.apollo.cache.ImageFetcher} used to fetch images asynchronously.
     */
     ...
     * @param context The {@link android.content.Context} to use.
     */
    public static void showColorPicker(final SettingsActivity context) {
        ...
        colorPickerView.setButton(AlertDialog.BUTTON_POSITIVE,
                context.getString(android.R.string.ok), new OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, final int which) {
                        ...
                        PreferenceUtils.getInstance(context).setChangeThemeColor(true);
                        context.reload();
                    }
                });
