...
/**
 * A subclass of {@link com.andrew.apollo.cache.ImageWorker} that fetches images from a URL.
 */
public class ImageFetcher extends ImageWorker {
    ...
    /**
     * Creates a new instance of {@link com.andrew.apollo.cache.ImageFetcher}.
     *
    ...
    private static String getBestImage(MusicEntry e) {
        final ImageSize[] QUALITY = {ImageSize.EXTRALARGE, ImageSize.LARGE,
    ...
    /**
     * Download a {@link android.graphics.Bitmap} from a URL, write it to a disk and return the
     * File pointer. This implementation uses a simple disk cache.
     *
     * @param context   The context to use
     * @param urlString The URL to fetch
     * @return A {@link java.io.File} pointing to the fetched bitmap
     */
    ...
    /**
     * Decode and sample down a {@link android.graphics.Bitmap} from a file to the requested
     * width and height.
     *
     * @param filename  The full path of the file to decode
     * @param reqWidth  The requested width of the resulting bitmap
     * @param reqHeight The requested height of the resulting bitmap
     * @return A {@link android.graphics.Bitmap} sampled down from the original with the same
    ...
    protected String processImageUrl(final String artistName,
        ...
        switch (imageType) {
            case ARTIST:
                ...
                // Log.i("liweiping", "processImageUrl artist = " + artist);
                if (artist == null)
                    return null;
            ...
            case ALBUM:
                ...
                if (!PreferenceUtils.getInstance(mContext)
                        .downloadMissingLyricAndArtwork())
                    return null;
                final Artist correction = Artist
                        .getCorrection(mContext, artistName);
                // Log.i("liweiping", "processImageUrl correction = " +
                // correction);
                if (correction == null)
                    return null;
    ...
    public void loadCurrentArtistImage(final ImageView imageView) {
        loadImage(MusicUtils.getArtistName(), MusicUtils.getArtistName(), null,
                -1, imageView, ImageType.ARTIST);
    }

    public void loadCurrentArtistImage(final ImageView imageView,
                                       LoaderArtCallBack callBack) {
        loadImage(MusicUtils.getArtistName(), MusicUtils.getArtistName(), null,
                -1, imageView, ImageType.ARTIST, callBack);
    }
    ...
    public Bitmap getCachedArtwork(final String keyAlbum,
                                   final String keyArtist, final long keyId) {
        if (mImageCache != null) {
     ...
     * @param artistName The album artist in case we should have to download missing
     *                   artwork
     * @return The album art as an {@link android.graphics.Bitmap}
     */
    public Bitmap getArtwork(final String albumName, final long albumId,
                             final String artistName) {
