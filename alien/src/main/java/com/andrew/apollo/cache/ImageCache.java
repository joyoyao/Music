...
public final class ImageCache {
    ...
    /**
     * The {@link android.net.Uri} used to retrieve album art
     */
    ...
    /**
     * Used to create a singleton of {@link com.andrew.apollo.cache.ImageCache}
     *
     * @param context The {@link android.content.Context} to use
    ...
    /**
     * Find and return an existing ImageCache stored in a {@link com.andrew.apollo.cache.ImageCache.RetainFragment}
     * , if not found a new one is created using the supplied params and saved
     * to a {@link com.andrew.apollo.cache.ImageCache.RetainFragment}
     *
    ...
    /**
     * Locate an existing instance of this {@link android.app.Fragment} or if not found,
     * create and add it using {@link android.app.FragmentManager}
     *
     * @param fm The {@link android.app.FragmentManager} to use
     * @return The existing instance of the {@link android.app.Fragment} or the new instance
     * if just created
     */
     ...
     * {@link com.andrew.apollo.cache.ImageCache} object.
     */
    public static final class RetainFragment extends Fragment {
        ...
        /**
         * Empty constructor as per the {@link android.app.Fragment} documentation
         */
        ...
        /**
         * Store a single object in this {@link android.app.Fragment}
         *
    ...
    /**
     * Used to cache images via {@link com.andrew.apollo.cache.LruCache}.
     */
    public static final class MemoryCache extends LruCache<String, Bitmap> {
         ...
         *
         * @param maxSize The allowed size of the {@link com.andrew.apollo.cache.LruCache}
         */
