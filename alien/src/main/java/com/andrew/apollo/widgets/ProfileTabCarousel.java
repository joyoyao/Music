...
/**
 * A custom {@link android.widget.HorizontalScrollView} that displays up to two "tabs" in the
 * {@link com.andrew.apollo.ui.activities.ProfileActivity}. If the second tab is visible, a fraction of it will
...
public class ProfileTabCarousel extends HorizontalScrollView implements OnTouchListener {
    ...
    /**
     * @return The {@link android.widget.ImageView} in the first index.
     */
    ...
    /**
     * @return The {@link android.widget.ImageView} used to set the album art.
     */
    ...
    /**
     * Set the given {@link com.andrew.apollo.widgets.ProfileTabCarousel.Listener} to handle carousel events.
     */
    ...
    /**
     * @return The main {@link android.widget.ImageView} for the first tab
     */
