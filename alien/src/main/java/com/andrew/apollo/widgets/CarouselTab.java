...
public class CarouselTab extends FrameLayoutWithOverlay {
    ...
    public void blurPhoto(final Activity context, final String artist,
        ...
        final Bitmap blur = BlurTransformation.transform(getContext(), artistImage);
    ...
    public void setAlbumPhoto(final Activity context, final String album, final String artist) {
        mFetcher.loadAlbumImage(artist, album, MusicUtils.getIdForAlbum(context, album, artist), mPhoto);
...
//        }
    ...
    public void setDefault(final Context context) {
        ...
        mPhoto.setImageDrawable(new ColorDrawable(PreferenceUtils.getInstance(context).getDefaultThemeColor(context)));
    }
    ...
    /**
     * @return The {@link android.widget.ImageView} used to set the header photo.
     */
