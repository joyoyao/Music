...
/**
 * A custom {@link android.widget.ImageButton} that represents the "play and pause" button.
 *
...
//				new PorterDuffColorFilter(PreferenceUtils.getInstance(context).getDefaultThemeColor(context),
