...
/**
 * Shows the {@link com.andrew.apollo.widgets.ColorPanelView} in a new {@link android.app.AlertDialog}.
 *
...
public class ColorSchemeDialog extends AlertDialog implements
        ...
        public void onClick(final View v) {
            switch (v.getId()) {
                case R.id.color_scheme_dialog_preset_one:
                    mColorPicker.setColor(getColor(R.color.material_blue));
                    break;
                case R.id.color_scheme_dialog_preset_two:
                    mColorPicker.setColor(getColor(R.color.material_teal));
                    break;
                case R.id.color_scheme_dialog_preset_three:
                    mColorPicker.setColor(getColor(R.color.material_yellow));
                    break;
                case R.id.color_scheme_dialog_preset_four:
                    mColorPicker.setColor(getColor(R.color.material_pink));
                    break;
                case R.id.color_scheme_dialog_preset_five:
                    mColorPicker.setColor(getColor(R.color.material_indigo));
                    break;
                case R.id.color_scheme_dialog_preset_six:
                    mColorPicker.setColor(getColor(R.color.material_red));
                    break;
                case R.id.color_scheme_dialog_preset_seven:
                    mColorPicker.setColor(getColor(R.color.loco));
                    break;
                case R.id.color_scheme_dialog_preset_eight:
                    mColorPicker.setColor(getColor(R.color.action_bar_color));
                    break;
    ...
    /**
     * @return {@link com.andrew.apollo.widgets.ColorPickerView}'s current color
     */
    public int getColor() {
