...
public class PrefixHighlighter {
    ...
    /**
     * Sets the text on the given {@link android.widget.TextView}, highlighting the word that
     * matches the given prefix.
     *
     * @param view   The {@link android.widget.TextView} on which to set the text
