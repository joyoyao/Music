...
/**
 * Used to query {@link android.provider.MediaStore.Audio.Genres.EXTERNAL_CONTENT_URI} and return
...
public class GenreLoader extends WrappedAsyncTaskLoader<List<Genre>> {
     ...
     *
     * @param context The {@link android.content.Context} to use.
     * @return The {@link android.database.Cursor} used to run the genre query.
     */
