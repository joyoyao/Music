...
/**
 * Used to query {@link android.provider.MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI} and
...
public class ArtistLoader extends WrappedAsyncTaskLoader<List<Artist>> {
     ...
     *
     * @param context The {@link android.content.Context} to use.
     * @return The {@link android.database.Cursor} used to run the artist query.
     */
