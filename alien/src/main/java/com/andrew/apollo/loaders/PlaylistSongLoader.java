...
/**
 * Used to query {@link android.provider.MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI} and
...
public class PlaylistSongLoader extends WrappedAsyncTaskLoader<List<Song>> {
     ...
     * @return The {@link android.database.Cursor} used to run the song query.
     */
