...
public class LyricListView extends ListView {
    ...
    private static final String TAG = LongPlayView.TAG + ".LyricListView";
    ...
    private void init() {
        ...
        mNormalColor = getResources().getColor(R.color.lrc_normal_color);
        mHighLightColor = getResources().getColor(R.color.lrc_hightlight_color);
